...
$(document).ready(function() {
  ...
  $("#subMenuGestionUsers").css({
    'display': 'none'
  });

  $("#subMenuGestionAgenda").css({
    'display': 'none'
  });

  $("#subMenuGestionMultimedia").css({
    'display': 'none'
  });

  $("#targetGestionUsers").css({
    'cursor': 'pointer'
  });

  $("#targetGestionAgenda").css({
    'cursor': 'pointer'
  });

  $("#targetGestionMultimedia").css({
    'cursor': 'pointer'
  });
  ...
  $("#form-tooltip-information-user").css({
    'display': 'none'
  });

  $("#form-tooltip-my-files").css({
    'display': 'none'
  });

  $("#form-tooltip-close-session").css({
    'display': 'none'
  });
